...
const projects = {
    ...
    'large-language-model': {
        ...
        content: `
            ...
            <p>Hier war es Aufgabe mithilfe von künstlicher Intelligenz, Valtown und API's ein Large Language Model zu kreieren. Im Vordergrund steht also eine API, die auf Kommando etwas generiert.</p>
    ...
    'general-reflection': {
        ...
        content: `
            ...
            Während sich das erste Semester auf grundlegende Konzepte konzentrierte, ging es in diesem Semester darum, neue und komplexe Technologien zu integrieren, insbesondere verschiedene Formen der künstlichen Intelligenz. Die Projekte – darunter ein generativer Roman, ein Chatbot im Fanfiction-Stil und eine mit KI trainierte Teachable Machine-Anwendung – waren weitaus anspruchsvoller, aber die Möglichkeit, mit diesen Tools zu arbeiten, ermöglichte es mir, in einem viel schnelleren Tempo zu lernen und zu arbeiten.
...
<br>
Insgesamt fand ich die Projekte persönlich viel ansprechender und faszinierender und genoss die Arbeit daran sehr. Selbstverständlich waren sie anspruchsvoller, doch durch die Möglichkeit der Nutzung von Künstlicher Intelligenz als Unterstützung, hatte ich das Gefühl, dass ich dadurch mit dem Ergebnis der Projekte zufriedener war und mich nicht so begrenzt gefühlt.</p>
  <a href="https://github.com/hbk-bs/documentation-2025-nicolesophiebelger/blob/main/assets/AGI-komprimiert.pdf" target="_blank">Github Repository</a>
            <br><br>      `
    }
